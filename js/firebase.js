...
function submitForm(e){
  ...
  // Save message
  saveMessage(name, restaurant, instagram, contact, date, expert);
...
function saveMessage(name, restaurant, instagram, contact, date, expert){
